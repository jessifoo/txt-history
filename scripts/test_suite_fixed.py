#!/usr/bin/env python3
"""
Fixed test suite for iMessage Exporter.
"""
...
def test_message_processor():
    ...
    try:
        ...
        messages = [
            Message("Alice", datetime(2024, 1, 1, 10, 0, 0), "Hello!", "Alice", "test.txt"),
            Message("You", datetime(2024, 1, 1, 10, 1, 0), "Hi there!", "Alice", "test.txt"),
            Message("Bob", datetime(2024, 1, 2, 11, 0, 0), "How are you?", "Bob", "test.txt")
        ]
        
        # Test storing messages (using the correct method signature)
...
def test_gui_components_simple():
...
def run_integration_test():
    ...
    try:
        ...
        # Add some messages
        messages = [
            Message("Test User", datetime(2024, 1, 1, 10, 0, 0), "Hello!", "Test User", "test.txt"),
            Message("You", datetime(2024, 1, 1, 10, 1, 0), "Hi there!", "Test User", "test.txt"),
            Message("Test User", datetime(2024, 1, 1, 10, 2, 0), "How are you?", "Test User", "test.txt")
        ]
        processor.store_messages(messages)
...
def main():
    """Run all tests."""
    print("🧪 Running iMessage Exporter Test Suite (Fixed)")
    print("=" * 60)
    ...
    tests = [
        ...
        ("GUI Components", test_gui_components_simple),
